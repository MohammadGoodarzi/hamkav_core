# Generated by Django 4.1.9 on 2023-06-20 15:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('HamkavBlog', '0005_blogpage_categories'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='HamkavBlog.formpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
